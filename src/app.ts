document.addEventListener('DOMContentLoaded', () => {
    const displayStreaks = async () => {
        try {
            ...
            const streaksContainer = document.getElementById('streaksContainer') as HTMLDivElement;
    ...
    //         }
    //     }
    async function deleteStreak(streakId: number) {
        try {
    ...
    const addStreakBtn = document.getElementById('addStreakBtn') as HTMLDivElement;
    const streakFormPopup = document.getElementById('streakFormPopup') as HTMLDivElement;
    ...
    formContainer.addEventListener('submit', (event) => {
        ...
        // Get form data
        const streakName = (formContainer.querySelector('input[name="streakName"]') as HTMLInputElement).value;
        const description = (formContainer.querySelector('input[name="description"]') as HTMLInputElement).value;
        const startDate = (formContainer.querySelector('input[name="startDate"]') as HTMLInputElement).value;
